...
Please report any bugs or feature requests to C<bug-app-zofcms-plugin-getremotepagetitle at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=App-ZofCMS-Plugin-GetRemotePageTitle>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=App-ZofCMS-Plugin-GetRemotePageTitle>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/App-ZofCMS-Plugin-GetRemotePageTitle>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/App-ZofCMS-Plugin-GetRemotePageTitle>

=item * Search CPAN

L<http://search.cpan.org/dist/App-ZofCMS-Plugin-GetRemotePageTitle/>
